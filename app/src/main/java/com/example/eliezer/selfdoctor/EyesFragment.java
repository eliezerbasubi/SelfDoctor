...
public class EyesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_eyes, container, false);

        mDatabase = FirebaseDatabase.getInstance().getReference().child("Disease").child("eye");
        mDatabase.keepSynced(true);

        recyclerView = mView.findViewById(R.id.recyclerEye);
