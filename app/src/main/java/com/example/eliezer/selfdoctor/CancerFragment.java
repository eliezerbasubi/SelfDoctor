...
public class CancerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_cancer, container, false);

        mDatabase = FirebaseDatabase.getInstance().getReference().child("Disease").child("cancer");
        mDatabase.keepSynced(true);

        recyclerView = mView.findViewById(R.id.listItem);
