...
public class EndocrineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_endocrine, container, false);

        mDatabase = FirebaseDatabase.getInstance().getReference().child("Disease").child("endocrine");
        mDatabase.keepSynced(true);

        recyclerView = mView.findViewById(R.id.recyclerEndocrine);
